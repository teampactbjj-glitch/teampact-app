    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-red-900 p-4" dir="rtl">
      ...
      <main id="main-content" className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            {(props) => (
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute left-2 top-1/2 -translate-y-1/2 p-1.5 text-gray-500 hover:text-gray-800 focus:outline focus:outline-2 focus:outline-offset-1 focus:outline-red-400 rounded"
                >
                  {showPassword ? (
        ...
        <div className="mt-6 pt-6 border-t text-center">
          ...
          <a
            href="/accessibility"
            className="block mt-2 text-xs text-gray-500 hover:text-gray-700 transition focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-red-400 rounded"
          >
