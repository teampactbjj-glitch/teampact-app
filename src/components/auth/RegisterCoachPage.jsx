              ...
              {(props) => (
                <div className="relative">
                  <input
                    ...
                    className="w-full border rounded-lg px-3 py-2 pl-10 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              {(props) => (
                <div className="relative">
                  ...
                  <button
                    ...
                    aria-label={showPasswordConfirm ? 'הסתר סיסמה' : 'הצג סיסמה'}
